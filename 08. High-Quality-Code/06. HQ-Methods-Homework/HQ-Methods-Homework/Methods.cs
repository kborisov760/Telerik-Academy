    ...
    class Methods
    {
        ...
        static string ConvertNumberToDigit(int number)
        {
            switch (number)
            {
                ...
                case 8: return "eight";
                case 9: return "nine";
                default: throw new ArgumentException("Invalid input number! Number must be between 0 and 9.");
            }
        }

        static int FindMaxFromGivenNumbers(params int[] elements)
        {
            if (elements == null || elements.Length == 0)
            {
                throw new ArgumentException("You must pass numbers to the method!");
            }
        ...
        public static void Main()
        {
            ...
            Console.WriteLine(FindMaxFromGivenNumbers(5, -1, 3, 2, 14, 2, 3));
